...
import com.cms.dao.QueryGroupDao;
...
@Service
public class QueryGroupServiceImpl extends ServiceImpl<QueryGroupDao, YlLaBranchGroupEntity> implements QueryGroupService {
    @Override
